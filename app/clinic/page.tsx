                    ...
                    <Reveal direction="up" delay={0.2}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                            ...
                            <div className="group relative rounded-[2rem] overflow-hidden bg-[#111] border border-white/5 aspect-square md:aspect-[4/3] shadow-[0_20px_40px_rgba(0,0,0,0.5)]">
                                ...
                                <div className="absolute inset-y-0 right-0 w-1/2 bg-orange-500/10 flex items-center justify-center border-l-2 border-orange-500 backdrop-blur-sm transition-all duration-700 ease-in-out group-hover:w-[95%]">
                                    <div className="absolute inset-0 bg-gradient-to-r from-transparent to-orange-500/20 mix-blend-overlay" />
                                    <span className="text-orange-400 font-bold text-2xl drop-shadow-md z-10">بعد</span>
                                    <div className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 w-8 h-8 bg-orange-500 rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(249,115,22,0.5)] cursor-ew-resize">
                                        <span className="text-black text-xs">↔</span>
                                    </div>
                                </div>
                                <div className="absolute bottom-6 right-6 bg-black/60 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 text-white text-sm font-medium">
                    ...
                    <Reveal direction="up">
                        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                            <div className="max-w-2xl">
                                <h2 className="text-sm md:text-base font-bold text-[#D4AF37] tracking-widest uppercase mb-3">تجارب حقيقية</h2>
                                <h3 className="text-4xl md:text-5xl font-black text-white">ماذا يقول عملاؤنا؟</h3>
                            </div>
                    ...
                    <Reveal direction="up" delay={0.2}>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="group relative rounded-[2rem] aspect-[9/16] bg-zinc-900 overflow-hidden cursor-pointer border border-white/5 hover:border-[#D4AF37]/50 transition-colors">
                                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?w=600&h=1000&fit=crop')] bg-cover bg-center opacity-60 group-hover:opacity-40 transition-opacity duration-700" />
                                ...
                                <div className="absolute bottom-6 left-6 right-6">
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <div>
                                            <p className="text-white font-bold text-sm">سارة م.</p>
                                            <div className="flex text-[#D4AF37] text-xs">★★★★★</div>
                                        </div>
                                    </div>
                                    <p className="text-zinc-300 text-sm italic">"تجربة الهايدرافيشل كانت خيالية، النضارة فورية والمسام اختفت!"</p>
                                </div>
                            </div>
                            ...
                            <div className="group relative rounded-[2rem] aspect-[9/16] bg-zinc-900 overflow-hidden cursor-pointer border border-white/5 hover:border-[#D4AF37]/50 transition-colors md:-translate-y-8">
                                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1522337660859-02fbefca4702?w=600&h=1000&fit=crop')] bg-cover bg-center opacity-60 group-hover:opacity-40 transition-opacity duration-700" />
                                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent" />
                                ...
                                <div className="absolute bottom-6 left-6 right-6">
                                    <div className="flex items-center gap-3 mb-3">
                                        <div className="w-10 h-10 rounded-full bg-zinc-800 border-2 border-[#D4AF37]" />
                                        <div>
                                            <p className="text-white font-bold text-sm">أمل ر.</p>
                                            <div className="flex text-[#D4AF37] text-xs">★★★★★</div>
                                        </div>
                                    </div>
                                    <p className="text-zinc-300 text-sm italic">"عانيت من القشرة لسنوات، جلسة الديتوكس فرقت معي من أول مرة."</p>
                                </div>
                            </div>
