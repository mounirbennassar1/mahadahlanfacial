            ...
            <div className="container relative z-20 mx-auto px-6 lg:px-12 flex h-full items-center pl-0">
                <div className="w-full md:w-[80vw] lg:w-[65vw] pt-20">
                    ...
                    <div ref={ctaGroup} className="flex flex-col sm:flex-row items-center justify-start gap-4 md:gap-6">
                        <MagneticButton>
                            <a href="#booking" className="group relative w-full sm:w-auto px-8 md:px-12 py-5 bg-[#D4AF37] text-black font-bold text-lg overflow-hidden transition-all hover:scale-105 active:scale-95 block text-center rounded-2xl">
                        ...
                        <MagneticButton>
                            <a href="#services" className="w-full sm:w-auto px-8 md:px-12 py-5 border border-white/20 hover:border-[#D4AF37]/50 bg-black/40 hover:bg-black/60 text-white font-medium backdrop-blur-md transition-all duration-300 text-lg block text-center rounded-2xl">
                                اكتشف خدماتنا
                            </a>
                        </MagneticButton>
                    </div>
